...
const Navbar = () => {
  return (
    <div className='w-fixed lg:w-1/5 sm:w-full flex-shrink flex-grow-0 px-2 border-r-2'>
      <div className='sticky top-0 p-4 w-full h-full'>
        <ul className='flex sm:flex-col overflow-hidden align-center justify-center items-center'>
          <li className='py-2 '>
            <h2 className='logo'>
              Parallel
              <br />
          ...
          <div className='flex sm:flex-row md:inline mx-2'>
        ...
        <div className='text-xs flex justify-between border-t-2'>
